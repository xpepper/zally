...
interface Context {
    ...
    /**
     * The [OpenAPI] being analysed.
     * NOTE: This version is being "recorded" to keep traces of the last
     *       accessed property, allowing quick violation creation.
     */
    val api: OpenAPI

    /**
     * Direct access to the [OpenAPI] object, bypassing the `Recorder`.
     * Necessary for certain cases where the `Recorder` causes problems.
     */
